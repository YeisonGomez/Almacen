...
var ProfileSQL = (function () {
    ...
    ProfileSQL.prototype.getUser = function () {
        var context = this;
        var currentUserSubject = this.currentUserSubject;
    ...
    ProfileSQL.prototype.setUserObservable = function (user) {
...
var User = (function () {
    ...
    User.prototype.setProfile = function (profile_name, profile_lastname, profile_gender, profile_rh, profile_email, profile_rol, profile_departament, profile_municipality, profile_state, profile_photo) {
